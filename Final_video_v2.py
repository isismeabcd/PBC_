...
class maketree(tk.Frame):
    ...
    #------------------------第二題：離群值
        ...
        self.Q2_2 = tk.Radiobutton(self, text = '否，保留離群值', variable = radioValue, value = 2, font = f4) ###補值---------------------------------------------------------------
    ...
    #------------------------第三題：缺失值
        ...
        self.Q3_1 = tk.Radiobutton(self, text = '無', variable = radioValue2, value = 1 , font = f4,command=lambda:self.knncheck(1))
        self.Q3_2 = tk.Radiobutton(self, text = '中位數', variable = radioValue2, value = 2, font = f4, command=lambda:self.knncheck(2)) ###補值--------------------------------------------------------------------
        self.Q3_3 = tk.Radiobutton(self, text = '眾數', variable = radioValue2, value = 3 , font = f4, command=lambda:self.knncheck(3)) ###補值---------------------------------------------------------------------
        self.Q3_4 = tk.Radiobutton(self, text = 'KNN Imputer', variable = radioValue2, value = 4, font = f4,command=lambda:self.knncheck(4))
    ...
    #------------------------第四題：降維度
        ...
        self.Q4_2 = tk.Radiobutton(self, text = '否', variable = radioValue3, value = 2, font = f4) ###補值------------------------------------------------------------------------
    ...
    def check_outlier(self):
        ...
        X = pp.decomposition(dataset, x_columns=[i for i in range(1, colnum)])
    ...
    def check_missing(self,boo):
        def knn_check_missing(dataframe):
            ...
            if boo:
                ...
                inputer=SimpleImputer(missing_val = '', strategy = 'median')
            elif radioValue2 == 3:
                inputer=SimpleImputer(missing_val = '', strategy = 'most_frequent')
    ...
    def runmodel(self,f):
        ...
        colnum = dataset.shape[1]
        X, Y = pp.decomposition(dataset, x_columns=[i for i in range(1, colnum)], y_columns=[0])
        X = pp.onehot_encoder(X, columns=[i for i in range(colnum-1)], remove_trap=True)
